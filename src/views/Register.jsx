...
export default function Register() {
    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit(showData)} className="form">
                <fieldset className="fieldset bg-base-200 border-base-300 rounded-box w-xs border mt-[50px] text-center p-4">
                    ...
                    <div>
                        <input
                            ...
                            {...register("confirm_password", { required: "Password obbligatoria", minLength: { value: 6, message: "Minimo 6 caratteri"}, 
                            })}
                            />
                            {errors.password && <p className="text-error">{errors.password.message}</p>}
                    </div>
